...
- Sau khi debug với username là Layla thì dword_4030C8 có giá trị là: 7888C9DF.
...
- Tiếp theo là hàm if: điều kiện trong hàm này cực ngoằn ngoèo, tuy nhiên phải đảm bảo điều kiện này đúng để có thể vào dòng 89. Hàm `_byteswap_ulong` sẽ đảo các bit của chuỗi đó (ví dụ: 1234 thành 4321) cho nên sẽ đảo các bit của dword_4030C8 lại cho dễ tính: DFC98878.
...
((serial[1] + 16 * serial[0]) ^ 0x12) + 52 = 0xDF **=> serial[0,1] = b9**      
